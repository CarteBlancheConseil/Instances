...
//bTrace trc("lib::init",false);
	(*elt)=(bGenericXMLBaseElement*)new bVarV1(NULL,gapp,bndl);
//trc.msg("parent instance (%x) of %s created",(*elt),"bVarV1");

bGenericXMLBaseElement*	chld;
	
	chld=new bfvar1Element(*elt,gapp,bndl);
...
//trc.msg("parent instance (%x) of %s deleted",elt,"bVarV1");
	delete (bVarV1*)(void*)elt;
}
