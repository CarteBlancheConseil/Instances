...
//bTrace trc("lib::init",false);
	(*elt)=(bGenericXMLBaseElement*)new bVarV2(NULL,gapp,bndl);
//trc.msg("parent instance (%x) of %s created",(*elt),"bVarV2");

bGenericXMLBaseElement*	chld;
	
	chld=new bfvar2Element(*elt,gapp,bndl);
...
//trc.msg("parent instance (%x) of %s deleted",elt,"bVarV2");
	delete (bVarV2*)(void*)elt;
}
