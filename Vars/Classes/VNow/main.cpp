...
//bTrace trc("lib::init",false);
	(*elt)=(bGenericXMLBaseElement*)new bVarVNow(NULL,gapp,bndl);
//trc.msg("parent instance (%x) of %s created",(*elt),"bVarVNow");

bGenericXMLBaseElement*	chld;
	
	chld=new bfvarNowElement(*elt,gapp,bndl);
...
//trc.msg("parent instance (%x) of %s deleted",elt,"bVarVNow");
	delete (bVarVNow*)(void*)elt;
}
