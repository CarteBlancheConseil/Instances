...
//bTrace trc("lib::init",false);
	(*elt)=(bGenericXMLBaseElement*)new bVarVPi(NULL,gapp,bndl);
//trc.msg("parent instance (%x) of %s created",(*elt),"bVarVPi");

bGenericXMLBaseElement*	chld;
	
	chld=new bfvarPiElement(*elt,gapp,bndl);
...
//trc.msg("parent instance (%x) of %s deleted",elt,"bVarVPi");
	delete (bVarVPi*)(void*)elt;
}
