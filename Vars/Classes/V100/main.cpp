...
//bTrace trc("lib::init",false);
	(*elt)=(bGenericXMLBaseElement*)new bVarV100(NULL,gapp,bndl);
//trc.msg("parent instance (%x) of %s created",(*elt),"bVarV100");

bGenericXMLBaseElement*	chld;
	
	chld=new bfvar100Element(*elt,gapp,bndl);
...
//trc.msg("parent instance (%x) of %s deleted",elt,"bVarV100");
	delete (bVarV100*)(void*)elt;
}
