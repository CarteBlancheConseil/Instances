...
//bTrace trc("lib::init",false);
	(*elt)=(bGenericXMLBaseElement*)new bVarV10(NULL,gapp,bndl);
//trc.msg("parent instance (%x) of %s created",(*elt),"bVarV10");

bGenericXMLBaseElement*	chld;
	
	chld=new bfvar10Element(*elt,gapp,bndl);
...
//trc.msg("parent instance (%x) of %s deleted",elt,"bVarV10");
	delete (bVarV10*)(void*)elt;
}
