...
//bTrace trc("lib::init",false);
	(*elt)=(bGenericXMLBaseElement*)new bVarVe(NULL,gapp,bndl);
//trc.msg("parent instance (%x) of %s created",(*elt),"bVarVe");

bGenericXMLBaseElement*	chld;
	
	chld=new bfvareElement(*elt,gapp,bndl);
...
//trc.msg("parent instance (%x) of %s deleted",elt,"bVarVe");
	delete (bVarVe*)(void*)elt;
}
