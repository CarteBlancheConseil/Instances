...
//bTrace trc("lib::init",false);
	(*elt)=(bGenericXMLBaseElement*)new bVarV1000(NULL,gapp,bndl);
//trc.msg("parent instance (%x) of %s created",(*elt),"bVarV1000");

bGenericXMLBaseElement*	chld;
	
	chld=new bfvar1000Element(*elt,gapp,bndl);
...
//trc.msg("parent instance (%x) of %s deleted",elt,"bVarV1000");
	delete (bVarV1000*)(void*)elt;
}
