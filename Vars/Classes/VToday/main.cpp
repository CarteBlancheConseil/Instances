...
//bTrace trc("lib::init",false);
	(*elt)=(bGenericXMLBaseElement*)new bVarVToday(NULL,gapp,bndl);
//trc.msg("parent instance (%x) of %s created",(*elt),"bVarVToday");

bGenericXMLBaseElement*	chld;
	
	chld=new bfvarTodayElement(*elt,gapp,bndl);
...
//trc.msg("parent instance (%x) of %s deleted",elt,"bVarVToday");
	delete (bVarVToday*)(void*)elt;
}
