...
//
// -----------
bool bXMapLine2Surf::edit(void* prm){
_bTrace_("bXMapLine2Surf::edit()",true);
long    result=0;
...
//
// ------------
void bXMapLine2Surf::set_data(long tlim, long tsrf, long stp){
    _tl=_gapp->typesMgr()->get(tlim);
    _ts=_gapp->typesMgr()->get(tsrf);
    _stp=stp;
}
...
bEventLog	log(_gapp,this);
	for(long i=1;i<=l2s_surf::_elts.count();i++){
