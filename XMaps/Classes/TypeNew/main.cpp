...
#include <xmap_lib/bXMapTypeNew.h>
...
//bTrace trc("lib::init",false);
	(*elt)=new bXMapTypeNew(NULL,gapp,bndl);
//trc.msg("parent instance (%x) of %s created",(*elt),"bXMapTypeNew");
}
...
//trc.msg("parent instance (%x) of %s deleted",elt,"bXMapTypeNew");
	delete (bXMapTypeNew*)(void*)elt;
}
