...
//
// -----------
bool bXMapNetClean::edit(void* prm){
_bTrace_("bXMapNetClean::edit()",true);
long    result=0;
...
//
// -----------
bool bXMapNetClean::nsevent(void* nsevt){
...
init_prm*	p=(init_prm*)prm;
    geo->setValue(p->field,kXMapNetCleanControlFieldDefault);
    return(0);
}
