...
#include <xmap_lib/bXMapViewMgr.h>
...
//bTrace trc("lib::init",false);
	(*elt)=new bXMapViewMgr(NULL,gapp,bndl);
//trc.msg("parent instance (%x) of %s created",(*elt),"bXMapViewMgr");
}
...
//trc.msg("parent instance (%x) of %s deleted",elt,"bXMapViewMgr");
	delete (bXMapViewMgr*)(void*)elt;
}
