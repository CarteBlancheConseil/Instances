...
//bTrace trc("lib::init",false);
	(*elt)=new bXMapScale(NULL,gapp,bndl);
//trc.msg("parent instance (%x) of %s created",(*elt),"bXMapScale");
}
...
//trc.msg("parent instance (%x) of %s deleted",elt,"bXMapScale");
	delete (bXMapScale*)(void*)elt;
}
