...
//bTrace trc("lib::init",false);
	(*elt)=new bXMapPrint(NULL,gapp,bndl);
//trc.msg("parent instance (%x) of %s created",(*elt),"bXMapPrint");
}
...
//trc.msg("parent instance (%x) of %s deleted",elt,"bXMapPrint");
	delete (bXMapPrint*)(void*)elt;
}
