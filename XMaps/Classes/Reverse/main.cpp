...
#include <xmap_lib/bXMapReverse.h>
...
//bTrace trc("lib::init",false);
	(*elt)=new bXMapReverse(NULL,gapp,bndl);
//trc.msg("parent instance (%x) of %s created",(*elt),"bXMapReverse");
}
...
//trc.msg("parent instance (%x) of %s deleted",elt,"bXMapReverse");
	delete (bXMapReverse*)(void*)elt;
}
