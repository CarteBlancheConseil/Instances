...
//bTrace trc("lib::init",false);
	(*elt)=new bXMapPaint(NULL,gapp,bndl);
//trc.msg("parent instance (%x) of %s created",(*elt),"bXMapPaint");
}
...
//trc.msg("parent instance (%x) of %s deleted",elt,"bXMapPaint");
	delete (bXMapPaint*)(void*)elt;
}
