...
//bTrace trc("lib::init",false);
	(*elt)=new bXMapInv(NULL,gapp,bndl);
//trc.msg("parent instance (%x) of %s created",(*elt),"bXMapInv");
}
...
//trc.msg("parent instance (%x) of %s deleted",elt,"bXMapInv");
	delete (bXMapInv*)(void*)elt;
}
