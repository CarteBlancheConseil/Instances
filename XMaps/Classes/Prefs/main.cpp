...
//bTrace trc("lib::init",false);
	(*elt)=new bXMapPrefs(NULL,gapp,bndl);
//trc.msg("parent instance (%x) of %s created",(*elt),"bXMapPrefs");
}
...
//trc.msg("parent instance (%x) of %s deleted",elt,"bXMapPrefs");
	delete (bXMapPrefs*)(void*)elt;
}
