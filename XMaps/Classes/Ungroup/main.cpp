...
#include <xmap_lib/bXMapUngroup.h>
...
//bTrace trc("lib::init",false);
	(*elt)=new bXMapUngroup(NULL,gapp,bndl);
//trc.msg("parent instance (%x) of %s created",(*elt),"bXMapUngroup");
}
...
//trc.msg("parent instance (%x) of %s deleted",elt,"bXMapUngroup");
	delete (bXMapUngroup*)(void*)elt;
}
