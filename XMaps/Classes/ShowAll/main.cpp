...
#include <xmap_lib/bXMapShowAll.h>
...
//bTrace trc("lib::init",false);
	(*elt)=new bXMapShowAll(NULL,gapp,bndl);
//trc.msg("parent instance (%x) of %s created",(*elt),"bXMapShowAll");
}
...
//trc.msg("parent instance (%x) of %s deleted",elt,"bXMapShowAll");
	delete (bXMapShowAll*)(void*)elt;
}
