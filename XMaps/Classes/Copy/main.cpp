...
//bTrace trc("lib::init",false);
	(*elt)=new bXMapCopy(NULL,gapp,bndl);
//trc.msg("parent instance (%x) of %s created",(*elt),"bXMapCopy");
}
...
//trc.msg("parent instance (%x) of %s deleted",elt,"bXMapCopy");
	delete (bXMapCopy*)(void*)elt;
}
