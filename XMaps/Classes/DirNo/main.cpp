...
#include <xmap_lib/bXMapsDirect.h>
...
//bTrace trc("lib::init",false);
	(*elt)=new bXMapNoDir(NULL,gapp,bndl);
//trc.msg("parent instance (%x) of %s created",(*elt),"bXMapNoDir");
}
...
//trc.msg("parent instance (%x) of %s deleted",elt,"bXMapNoDir");
	delete (bXMapNoDir*)(void*)elt;
}
