...
//bTrace trc("lib::init",false);
	(*elt)=new bXMapFExp(NULL,gapp,bndl);
//trc.msg("parent instance (%x) of %s created",(*elt),"bXMapFExp");
}
...
//trc.msg("parent instance (%x) of %s deleted",elt,"bXMapFExp");
	delete (bXMapFExp*)(void*)elt;
}
