...
#include <xmap_lib/bXMapDelete.h>
...
//bTrace trc("lib::init",false);
	(*elt)=new bXMapDelete(NULL,gapp,bndl);
//trc.msg("parent instance (%x) of %s created",(*elt),"bXMapDelete");
}
...
//trc.msg("parent instance (%x) of %s deleted",elt,"bXMapDelete");
	delete (bXMapDelete*)(void*)elt;
}
