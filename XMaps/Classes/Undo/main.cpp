...
//bTrace trc("lib::init",false);
	(*elt)=new bXMapUndo(NULL,gapp,bndl);
//trc.msg("parent instance (%x) of %s created",(*elt),"bXMapUndo");
}
...
//trc.msg("parent instance (%x) of %s deleted",elt,"bXMapUndo");
	delete (bXMapUndo*)(void*)elt;
}
