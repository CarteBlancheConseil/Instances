...
//bTrace trc("lib::init",false);
	(*elt)=new bXMapGoRight(NULL,gapp,bndl);
//trc.msg("parent instance (%x) of %s created",(*elt),"bXMapGoRight");
}
...
//trc.msg("parent instance (%x) of %s deleted",elt,"bXMapGoRight");
	delete (bXMapGoRight*)(void*)elt;
}
