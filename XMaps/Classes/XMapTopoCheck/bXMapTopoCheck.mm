...
//
// -----------
bool bXMapTopoCheck::edit(void* prm){
_bTrace_("bXMapTopoCheck::edit()",true);
long    result=0;
...
//
// -----------
bool bXMapTopoCheck::nsevent(void* nsevt){
...
bool					b=_gapp->document()->readTree(&root,'oThC'/*GetSignature(this)*/,kXMapTopoCheckConfig);
...
bGenericXMLBaseElement* root=make_p();
    ...
    if(!_gapp->document()->writeTree(root,'oThC'/*GetSignature(this)*/,kXMapTopoCheckConfig)){
        return;
    }
