...
//bTrace trc("lib::init",false);
	(*elt)=new bXMapGroup(NULL,gapp,bndl);
//trc.msg("parent instance (%x) of %s created",(*elt),"bXMapGroup");
}
...
//trc.msg("parent instance (%x) of %s deleted",elt,"bXMapGroup");
	delete (bXMapGroup*)(void*)elt;
}
