...
#include <xmap_lib/bXMapReIndex.h>
...
//bTrace trc("lib::init",false);
	(*elt)=new bXMapReIndex(NULL,gapp,bndl);
//trc.msg("parent instance (%x) of %s created",(*elt),"bXMapReIndex");
}
...
//trc.msg("parent instance (%x) of %s deleted",elt,"bXMapReIndex");
	delete (bXMapReIndex*)(void*)elt;
}
