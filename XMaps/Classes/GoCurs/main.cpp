...
//bTrace trc("lib::init",false);
	(*elt)=new bXMapGoCurs(NULL,gapp,bndl);
//trc.msg("parent instance (%x) of %s created",(*elt),"bXMapGoCurs");
}
...
//trc.msg("parent instance (%x) of %s deleted",elt,"bXMapGoCurs");
	delete (bXMapGoCurs*)(void*)elt;
}
