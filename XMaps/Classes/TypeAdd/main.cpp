...
#include <xmap_lib/bXMapTypeAdd.h>
...
//bTrace trc("lib::init",false);
	(*elt)=new bXMapTypeAdd(NULL,gapp,bndl);
//trc.msg("parent instance (%x) of %s created",(*elt),"bXMapTypeAdd");
}
...
//trc.msg("parent instance (%x) of %s deleted",elt,"bXMapTypeAdd");
	delete (bXMapTypeAdd*)(void*)elt;
}
