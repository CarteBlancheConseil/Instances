...
#include <xmap_lib/bXMapLineUp.h>
...
//bTrace trc("lib::init",false);
	(*elt)=new bXMapLineUp(NULL,gapp,bndl);
//trc.msg("parent instance (%x) of %s created",(*elt),"bXMapLineUp");
}
...
//trc.msg("parent instance (%x) of %s deleted",elt,"bXMapLineUp");
	delete (bXMapLineUp*)(void*)elt;
}
