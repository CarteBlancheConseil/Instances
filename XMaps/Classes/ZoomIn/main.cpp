...
#include <xmap_lib/bXMapZoomIn.h>
...
//bTrace trc("lib::init",false);
	(*elt)=new bXMapZoomIn(NULL,gapp,bndl);
//trc.msg("parent instance (%x) of %s created",(*elt),"bXMapZoomIn");
}
...
//trc.msg("parent instance (%x) of %s deleted",elt,"bXMapZoomIn");
	delete (bXMapZoomIn*)(void*)elt;
}
