...
//bTrace trc("lib::init",false);
	(*elt)=new bXMapGoDown(NULL,gapp,bndl);
//trc.msg("parent instance (%x) of %s created",(*elt),"bXMapGoDown");
}
...
//trc.msg("parent instance (%x) of %s deleted",elt,"bXMapGoDown");
	delete (bXMapGoDown*)(void*)elt;
}
