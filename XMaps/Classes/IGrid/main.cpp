...
//bTrace trc("lib::init",false);
	(*elt)=new bXMapIGrid(NULL,gapp,bndl);
//trc.msg("parent instance (%x) of %s created",(*elt),"bXMapIGrid");
}
...
//trc.msg("parent instance (%x) of %s deleted",elt,"bXMapIGrid");
	delete (bXMapIGrid*)(void*)elt;
}
