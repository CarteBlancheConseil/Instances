...
#include <xmap_lib/bXMapBuffer.h>
...
//bTrace trc("lib::init",false);
	(*elt)=new bXMapBuffer(NULL,gapp,bndl);
//trc.msg("parent instance (%x) of %s created",(*elt),"bXMapBuffer");
}
...
//trc.msg("parent instance (%x) of %s deleted",elt,"bXMapBuffer");
	delete (bXMapBuffer*)(void*)elt;
}
