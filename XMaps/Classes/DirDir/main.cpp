...
//bTrace trc("lib::init",false);
	(*elt)=new bXMapDir(NULL,gapp,bndl);
//trc.msg("parent instance (%x) of %s created",(*elt),"bXMapDir");
}
...
//trc.msg("parent instance (%x) of %s deleted",elt,"bXMapDir");
	delete (bXMapDir*)(void*)elt;
}
