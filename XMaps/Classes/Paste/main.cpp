...
//bTrace trc("lib::init",false);
	(*elt)=new bXMapPaste(NULL,gapp,bndl);
//trc.msg("parent instance (%x) of %s created",(*elt),"bXMapPaste");
}
...
//trc.msg("parent instance (%x) of %s deleted",elt,"bXMapPaste");
	delete (bXMapPaste*)(void*)elt;
}
