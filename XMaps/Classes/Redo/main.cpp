...
//bTrace trc("lib::init",false);
	(*elt)=new bXMapRedo(NULL,gapp,bndl);
//trc.msg("parent instance (%x) of %s created",(*elt),"bXMapRedo");
}
...
//trc.msg("parent instance (%x) of %s deleted",elt,"bXMapRedo");
	delete (bXMapRedo*)(void*)elt;
}
