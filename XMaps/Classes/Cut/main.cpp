...
//bTrace trc("lib::init",false);
	(*elt)=new bXMapCut(NULL,gapp,bndl);
//trc.msg("parent instance (%x) of %s created",(*elt),"bXMapCut");
}
...
//trc.msg("parent instance (%x) of %s deleted",elt,"bXMapCut");
	delete (bXMapCut*)(void*)elt;
}
