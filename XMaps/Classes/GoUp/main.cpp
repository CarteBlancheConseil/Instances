...
//bTrace trc("lib::init",false);
	(*elt)=new bXMapGoUp(NULL,gapp,bndl);
//trc.msg("parent instance (%x) of %s created",(*elt),"bXMapGoUp");
}
...
//trc.msg("parent instance (%x) of %s deleted",elt,"bXMapGoUp");
	delete (bXMapGoUp*)(void*)elt;
}
