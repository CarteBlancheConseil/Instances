...
//bTrace trc("lib::init",false);
	(*elt)=new bXMapGoLeft(NULL,gapp,bndl);
//trc.msg("parent instance (%x) of %s created",(*elt),"bXMapGoLeft");
}
...
//trc.msg("parent instance (%x) of %s deleted",elt,"bXMapGoLeft");
	delete (bXMapGoLeft*)(void*)elt;
}
