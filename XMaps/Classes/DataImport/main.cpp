...
#include <xmap_lib/bXMapDataImport.h>
...
//trc.msg("parent instance (%x) of %s created",(*elt),"bXMapDataImport");
}
...
//trc.msg("parent instance (%x) of %s deleted",elt,"bXMapDataImport");
