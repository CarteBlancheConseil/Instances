...
//bTrace trc("lib::init",false);
	(*elt)=new bXMapShake(NULL,gapp,bndl);
//trc.msg("parent instance (%x) of %s created",(*elt),"bXMapShake");
}
...
//trc.msg("parent instance (%x) of %s deleted",elt,"bXMapShake");
	delete (bXMapShake*)(void*)elt;
}
