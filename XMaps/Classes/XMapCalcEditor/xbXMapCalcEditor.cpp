...
_bTrace_("bXMapCalcEditor::edit()",true);
    _new=true;
    _name[0]=0;
    _value[0]=0;
    _fknd=0;
...
_bTrace_("bXMapCalcEditor::process()",true);
    switch(msg){
...
//
// -----------
void bXMapCalcEditor::get_infos(char* name,
                               char* value,
                               UInt32* kind){
    strcpy(name,_name);
    strcpy(value,_value);
...
//
// -----------
void bXMapCalcEditor::set_infos(const char* name,
                               const char* value,
                               UInt32 kind){
    strcpy(_name,name);
    strcpy(_value,value);
...
//    c=get_control(kXMapCalcEditorSignature,kXMapCalcEditorValueID);
