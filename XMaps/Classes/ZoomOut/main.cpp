...
#include <xmap_lib/bXMapZoomOut.h>
...
//bTrace trc("lib::init",false);
	(*elt)=new bXMapZoomOut(NULL,gapp,bndl);
//trc.msg("parent instance (%x) of %s created",(*elt),"bXMapZoomOut");
}
...
//trc.msg("parent instance (%x) of %s deleted",elt,"bXMapZoomOut");
	delete (bXMapZoomOut*)(void*)elt;
}
