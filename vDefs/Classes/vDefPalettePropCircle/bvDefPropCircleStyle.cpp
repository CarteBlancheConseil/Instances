//----------------------------------------------------------------------------
// File : bvDefPropCircleStyle.cpp
// Project : MacMap
// Purpose : C++ source file : proportionnal circle vdef style class
...
// Constructeur
// ------------
bvDefPropCircleStyle	::bvDefPropCircleStyle(	bGenericMacMapApp* gapp,
												bGenericType* gtp)
						:bvDefPalettePropStyle(gapp,gtp,true){
_bTrace_("bvDefPropCircleStyle::bvDefPropCircleStyle",true);
	_width=1;
	_stroke[0]=1;
	_stroke[1]=1;
	_stroke[2]=1;
...
// Destructeur
// -----------
bvDefPropCircleStyle::~bvDefPropCircleStyle(){
_bTrace_("bvDefPropCircleStyle::~bvDefPropCircleStyle",true);
}
...
// 
// ------------
bool bvDefPropCircleStyle::load(bGenericXMLBaseElement* root){
...
// 
// ------------
bool bvDefPropCircleStyle::dump(bArray& arr, int indent){
	if(_rref==0){
		return(true);
	}
	if(_width<=0){
