//----------------------------------------------------------------------------
// File : bvDefQuickSurfStyle.cpp
// Project : MacMap
// Purpose : C++ source file : Polygon vdef class
...
// Constructeur
// ------------
bvDefQuickSurfStyle::bvDefQuickSurfStyle(	bGenericMacMapApp* gapp,
											bGenericType* gtp,
											int clss)
...
// Destructeur
// -----------
bvDefQuickSurfStyle::~bvDefQuickSurfStyle(){
}

// ---------------------------------------------------------------------------
// 
// ------------
bool bvDefQuickSurfStyle::load(bGenericXMLBaseElement* root){
...
// 
// ------------
bool bvDefQuickSurfStyle::dump(bArray& arr, int indent){
char	nm[256];
	if(	(_width<=0)			&&
		(_fill[_cc-1]<=0)	&&
		(_fwidth==0)		&&
