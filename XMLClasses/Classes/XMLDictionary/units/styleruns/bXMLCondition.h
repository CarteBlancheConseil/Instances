//----------------------------------------------------------------------------
// File : bXMLCondition.h
// Project : MacMap
// Purpose : Header file : condition tag class, used in styles
...
#ifndef __bConditionElement__
#define __bConditionElement__
...
class bConditionElement : public bStdXMLRenderingElement{
	public:
		bConditionElement 						(	bGenericXMLBaseElement* elt, 
													bGenericMacMapApp* gapp, 
													CFBundleRef bndl );
		virtual ~bConditionElement  			(	);
