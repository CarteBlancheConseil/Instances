...
// File : bXMLBoxPos.h
// Project : MacMap
// Purpose : Header file : box from geometry tag class, used in styles
...
#ifndef __bBoxPosElement__
#define __bBoxPosElement__
...
class bBoxPosElement : public bStdXMLRenderingElement{
	public:
		bBoxPosElement							(	bGenericXMLBaseElement* elt, 
													bGenericMacMapApp* gapp, 
													CFBundleRef bndl );
		virtual ~bBoxPosElement					(	);
