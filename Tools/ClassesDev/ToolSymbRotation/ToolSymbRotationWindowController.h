...
//----------------------------------------------------------------------------
@interface ToolSymbRotationWindowController : bStdNSAppToolModalWindowController{
    IBOutlet NSButton*      _uac_chk;
    IBOutlet NSTextField*   _ang_lbl;
    IBOutlet NSTextField*   _ang_txt;
    IBOutlet NSTextField*   _ang_unt;
}
