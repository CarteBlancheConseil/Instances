...
//
// Copyright (C) 2009 Carte Blanche Conseil.
//
...
//
// -----------
bool bToolRedraw::edit(void* prm){
_bTrace_("bToolRedraw::edit",true);
long            result=0;
