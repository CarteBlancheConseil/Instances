...
#include <tool_lib/bToolLength.h>
...
//bTrace trc("lib::init",false);
	(*elt)=new bToolLength(NULL,gapp,bndl);
//trc.msg("parent instance (%x) of %s created",(*elt),"bToolLength");
}
...
//trc.msg("parent instance (%x) of %s deleted",elt,"bToolLength");
	delete (bToolLength*)(void*)elt;
}
