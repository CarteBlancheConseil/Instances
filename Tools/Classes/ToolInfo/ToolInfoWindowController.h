//----------------------------------------------------------------------------
// File : ToolInfoWindowController.h
// Project : MacMap
// Purpose : Header file : Tool Info window controller
...
//----------------------------------------------------------------------------
@interface ToolInfoWindowController : bStdNSAppToolModalWindowController{
    IBOutlet NSButton*      _sht_chk;
