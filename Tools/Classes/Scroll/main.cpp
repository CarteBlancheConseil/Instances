...
#include <tool_lib/bToolScroll.h>
...
//bTrace trc("lib::init",false);
	(*elt)=new bToolScroll(NULL,gapp,bndl);
//trc.msg("parent instance (%x) of %s created",(*elt),"bToolScroll");
}
...
//trc.msg("parent instance (%x) of %s deleted",elt,"bToolScroll");
	delete (bToolScroll*)(void*)elt;
}
