...
//bTrace trc("lib::init",false);
	(*elt)=new bToolCut(NULL,gapp,bndl);
//trc.msg("parent instance (%x) of %s created",(*elt),"bToolCut");
}
...
//trc.msg("parent instance (%x) of %s deleted",elt,"bToolCut");
	delete (bToolCut*)(void*)elt;
}
