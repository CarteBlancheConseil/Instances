...
//bTrace trc("lib::init",false);
	(*elt)=new bToolAlter(NULL,gapp,bndl);
//trc.msg("parent instance (%x) of %s created",(*elt),"bToolAlter");
}
...
//trc.msg("parent instance (%x) of %s deleted",elt,"bToolAlter");
	delete (bToolAlter*)(void*)elt;
}
