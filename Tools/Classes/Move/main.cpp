...
//bTrace trc("lib::init",false);
	(*elt)=new bToolMove(NULL,gapp,bndl);
//trc.msg("parent instance (%x) of %s created",(*elt),"bToolMove");
}
...
//trc.msg("parent instance (%x) of %s deleted",elt,"bToolMove");
	delete (bToolMove*)(void*)elt;
}
