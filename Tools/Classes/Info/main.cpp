...
//bTrace trc("lib::init",false);
	(*elt)=new bToolInfo(NULL,gapp,bndl);
//trc.msg("parent instance (%x) of %s created",(*elt),"bToolInfo");
}
...
//trc.msg("parent instance (%x) of %s deleted",elt,"bToolInfo");
	delete (bToolInfo*)(void*)elt;
}
