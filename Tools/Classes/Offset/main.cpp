...
#include <tool_lib/bToolOffset.h>
...
//bTrace trc("lib::init",false);
	(*elt)=new bToolOffset(NULL,gapp,bndl);
//trc.msg("parent instance (%x) of %s created",(*elt),"bToolOffset");
}
...
//trc.msg("parent instance (%x) of %s deleted",elt,"bToolOffset");
	delete (bToolOffset*)(void*)elt;
}
