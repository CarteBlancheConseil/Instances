...
//bTrace trc("lib::init",false);
	(*elt)=new bToolShape(NULL,gapp,bndl);
//trc.msg("parent instance (%x) of %s Shaped",(*elt),"bToolShape");
}
...
//trc.msg("parent instance (%x) of %s deleted",elt,"bToolShape");
	delete (bToolShape*)(void*)elt;
}
