...
//bTrace trc("lib::init",false);
	(*elt)=new bToolZoom(NULL,gapp,bndl);
//trc.msg("parent instance (%x) of %s created",(*elt),"bToolZoom");
}
...
//trc.msg("parent instance (%x) of %s deleted",elt,"bToolZoom");
	delete (bToolZoom*)(void*)elt;
}
