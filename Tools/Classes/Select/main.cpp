...
#include <tool_lib/bToolSelect.h>
...
//bTrace trc("lib::init",false);
	(*elt)=new bToolSelect(NULL,gapp,bndl);
//trc.msg("parent instance (%x) of %s created",(*elt),"bToolSelect");
}
...
//trc.msg("parent instance (%x) of %s deleted",elt,"bToolSelect");
	delete (bToolSelect*)(void*)elt;
}
