...
//bTrace trc("lib::init",false);
	(*elt)=new bGeogGInclude(NULL,gapp,bndl);
//trc.msg("parent instance (%x) of %s created",(*elt),"bGeogGInclude");
bGenericXMLBaseElement*	chld=new bIncludeElement(NULL,gapp,bndl);
...
//trc.msg("parent instance (%x) of %s deleted",elt,"bGeogGInclude");
	delete (bGeogGInclude*)(void*)elt;
}
