...
//bTrace trc("lib::init",false);
	(*elt)=new bGeogGNearest(NULL,gapp,bndl);
//trc.msg("parent instance (%x) of %s created",(*elt),"bGeogGNearest");
bGenericXMLBaseElement*	chld=new bNearestElement(NULL,gapp,bndl);
...
//trc.msg("parent instance (%x) of %s deleted",elt,"bGeogGNearest");
	delete (bGeogGNearest*)(void*)elt;
}
