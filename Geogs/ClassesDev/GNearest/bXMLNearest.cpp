//----------------------------------------------------------------------------
// File : bXMLNearest.cpp
// Project : MacMap
// Purpose : C++ source file : Nearest Geog formula class
...
// Constructeur
// ------------
bNearestElement	::bNearestElement(bGenericXMLBaseElement* elt, bGenericMacMapApp* gapp, CFBundleRef bndl ) 
				:bStdXMLGeog(elt,gapp,bndl){
	setclassname("nearest");
	_nb=0;
}
...
// Destructeur
// -----------
bNearestElement::~bNearestElement(){
}

// ---------------------------------------------------------------------------
// Constructeur
// ------------
bGenericXMLBaseElement* bNearestElement::create(bGenericXMLBaseElement* elt){
	return(new bNearestElement(elt,_gapp,elt->getbundle()));
}

// ---------------------------------------------------------------------------
// 
// -----------
void  bNearestElement::init(void* ctx){
...
// 
// -----------
void  bNearestElement::reset(bStdSolver* ctx){
