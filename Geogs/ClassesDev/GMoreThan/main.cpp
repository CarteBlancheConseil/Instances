...
//bTrace trc("lib::init",false);
	(*elt)=new bGeogGMoreThan(NULL,gapp,bndl);
//trc.msg("parent instance (%x) of %s created",(*elt),"bGeogGMoreThan");
bGenericXMLBaseElement*	chld=new bMoreThanElement(NULL,gapp,bndl);
...
//trc.msg("parent instance (%x) of %s deleted",elt,"bGeogGMoreThan");
	delete (bGeogGMoreThan*)(void*)elt;
}
