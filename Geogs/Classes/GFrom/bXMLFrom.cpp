...
// File : bXMLFrom.cpp
// Project : MacMap
// Purpose : C++ source file : From Geog formula class
...
// Constructeur
// ------------
bFromElement	::bFromElement(bGenericXMLBaseElement* elt, bGenericMacMapApp* gapp, CFBundleRef bndl ) 
...
// Destructeur
// -----------
bFromElement::~bFromElement(){
}

// ---------------------------------------------------------------------------
// Constructeur
// ------------
bGenericXMLBaseElement* bFromElement::create(bGenericXMLBaseElement* elt){
	return(new bFromElement(elt,_gapp,elt->getbundle()));
}

// ---------------------------------------------------------------------------
// 
// -----------
void  bFromElement::init(void* ctx){
...
// 
// -----------
int bFromElement::process(void* o, void* prm){
bFromElement*		gg=(bFromElement*)prm;
