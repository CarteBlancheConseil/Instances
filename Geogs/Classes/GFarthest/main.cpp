...
//bTrace trc("lib::init",false);
	(*elt)=new bGeogGFarthest(NULL,gapp,bndl);
//trc.msg("parent instance (%x) of %s created",(*elt),"bGeogGFarthest");
bGenericXMLBaseElement*	chld=new bFarthestElement(NULL,gapp,bndl);
...
//trc.msg("parent instance (%x) of %s deleted",elt,"bGeogGFarthest");
	delete (bGeogGFarthest*)(void*)elt;
}
