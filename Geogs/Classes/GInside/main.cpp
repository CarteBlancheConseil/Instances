...
//bTrace trc("lib::init",false);
	(*elt)=new bGeogGInside(NULL,gapp,bndl);
//trc.msg("parent instance (%x) of %s created",(*elt),"bGeogGInside");
bGenericXMLBaseElement*	chld=new bInsideElement(NULL,gapp,bndl);
...
//trc.msg("parent instance (%x) of %s deleted",elt,"bGeogGInside");
	delete (bGeogGInside*)(void*)elt;
}
