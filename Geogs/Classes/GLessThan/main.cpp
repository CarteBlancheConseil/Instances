...
//bTrace trc("lib::init",false);
	(*elt)=new bGeogGLessThan(NULL,gapp,bndl);
//trc.msg("parent instance (%x) of %s created",(*elt),"bGeogGLessThan");
bGenericXMLBaseElement*	chld=new bLessThanElement(NULL,gapp,bndl);
...
//trc.msg("parent instance (%x) of %s deleted",elt,"bGeogGLessThan");
	delete (bGeogGLessThan*)(void*)elt;
}
