...
//bTrace trc("lib::init",false);
	(*elt)=new bGeogGAtEnd(NULL,gapp,bndl);
//trc.msg("parent instance (%x) of %s created",(*elt),"bGeogGAtEnd");
bGenericXMLBaseElement*	chld=new bAtEndElement(NULL,gapp,bndl);
...
//trc.msg("parent instance (%x) of %s deleted",elt,"bGeogGAtEnd");
	delete (bGeogGAtEnd*)(void*)elt;
}
