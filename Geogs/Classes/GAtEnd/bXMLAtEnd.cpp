...
// File : bXMLAtEnd.cpp
// Project : MacMap
// Purpose : C++ source file : At end Geog formula class
...
// Constructeur
// ------------
bAtEndElement	::bAtEndElement(bGenericXMLBaseElement* elt, bGenericMacMapApp* gapp, CFBundleRef bndl ) 
...
// Destructeur
// -----------
bAtEndElement::~bAtEndElement(){
}

// ---------------------------------------------------------------------------
// Constructeur
// ------------
bGenericXMLBaseElement* bAtEndElement::create(bGenericXMLBaseElement* elt){
	return(new bAtEndElement(elt,_gapp,elt->getbundle()));
}

// ---------------------------------------------------------------------------
// 
// -----------
void  bAtEndElement::init(void* ctx){
...
// 
// -----------
int bAtEndElement::process(void* o, void* prm){
bAtEndElement*		gg=(bAtEndElement*)prm;
