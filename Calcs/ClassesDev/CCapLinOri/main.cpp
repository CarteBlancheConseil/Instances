...
//bTrace trc("lib::init",false);
	(*elt)=new bCalcCCapLinOri(NULL,gapp,bndl);
//trc.msg("parent instance (%x) of %s created",(*elt),"bCalcCCapLinOri");

bGenericXMLBaseElement*	chld;
	
	chld=new bfcalcCapLinOriElement(*elt,gapp,bndl);
...
//trc.msg("parent instance (%x) of %s deleted",elt,"bCalcCCapLinOri");
	delete (bCalcCCapLinOri*)(void*)elt;
}
