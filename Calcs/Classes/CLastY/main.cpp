...
//bTrace trc("lib::init",false);
	(*elt)=new bCalcCLastY(NULL,gapp,bndl);
//trc.msg("parent instance (%x) of %s created",(*elt),"bCalcCLastY");
bGenericXMLBaseElement*	chld;
	
	chld=new bfcalcLastYElement(*elt,gapp,bndl);
...
//trc.msg("parent instance (%x) of %s deleted",elt,"bCalcCLastY");
	delete (bCalcCLastY*)(void*)elt;
}
