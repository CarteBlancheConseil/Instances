...
//bTrace trc("lib::init",false);
	(*elt)=new bCalcCCentroidX(NULL,gapp,bndl);
//trc.msg("parent instance (%x) of %s created",(*elt),"bCalcCCentroidX");
bGenericXMLBaseElement*	chld;
	
	chld=new bfcalcCentroidXElement(*elt,gapp,bndl);
...
//trc.msg("parent instance (%x) of %s deleted",elt,"bCalcCCentroidX");
	delete (bCalcCCentroidX*)(void*)elt;
}
