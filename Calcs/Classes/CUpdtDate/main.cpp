...
//bTrace trc("lib::init",false);
	(*elt)=new bCalcCUpdtDate(NULL,gapp,bndl);
//trc.msg("parent instance (%x) of %s created",(*elt),"bCalcCUpdtDate");
bGenericXMLBaseElement*	chld;
	
	chld=new bfcalcUpdtDateElement(*elt,gapp,bndl);
...
//trc.msg("parent instance (%x) of %s deleted",elt,"bCalcCUpdtDate");
	delete (bCalcCUpdtDate*)(void*)elt;
}
