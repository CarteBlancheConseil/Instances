...
//bTrace trc("lib::init",false);
	(*elt)=new bCalcCAngleLin(NULL,gapp,bndl);
//trc.msg("parent instance (%x) of %s created",(*elt),"bCalcCAngleLin");

bGenericXMLBaseElement*	chld;
	
	chld=new bfcalcAngleLinElement(*elt,gapp,bndl);
...
//trc.msg("parent instance (%x) of %s deleted",elt,"bCalcCAngleLin");
	delete (bCalcCAngleLin*)(void*)elt;
}
