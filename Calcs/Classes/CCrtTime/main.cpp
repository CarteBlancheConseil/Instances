...
//bTrace trc("lib::init",false);
	(*elt)=new bCalcCCrtTime(NULL,gapp,bndl);
//trc.msg("parent instance (%x) of %s created",(*elt),"bCalcCCrtTime");
bGenericXMLBaseElement*	chld;
	
	chld=new bfcalcCrtTimeElement(*elt,gapp,bndl);
...
//trc.msg("parent instance (%x) of %s deleted",elt,"bCalcCCrtTime");
	delete (bCalcCCrtTime*)(void*)elt;
}
