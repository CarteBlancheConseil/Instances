...
//bTrace trc("lib::init",false);
	(*elt)=new bCalcCAngle(NULL,gapp,bndl);
//trc.msg("parent instance (%x) of %s created",(*elt),"bCalcCAngle");

bGenericXMLBaseElement*	chld;
	
	chld=new bfcalcAngleElement(*elt,gapp,bndl);
...
//trc.msg("parent instance (%x) of %s deleted",elt,"bCalcCAngle");
	delete (bCalcCAngle*)(void*)elt;
}
