...
//bTrace trc("lib::init",false);
	(*elt)=new bCalcCID(NULL,gapp,bndl);
//trc.msg("parent instance (%x) of %s created",(*elt),"bCalcCID");
bGenericXMLBaseElement*	chld;
	
	chld=new bfcalcIDElement(*elt,gapp,bndl);
...
//trc.msg("parent instance (%x) of %s deleted",elt,"bCalcCID");
	delete (bCalcCID*)(void*)elt;
}
