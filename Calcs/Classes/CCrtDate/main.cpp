...
//bTrace trc("lib::init",false);
	(*elt)=new bCalcCCrtDate(NULL,gapp,bndl);
//trc.msg("parent instance (%x) of %s created",(*elt),"bCalcCCrtDate");
bGenericXMLBaseElement*	chld;
	
	chld=new bfcalcCrtDateElement(*elt,gapp,bndl);
...
//trc.msg("parent instance (%x) of %s deleted",elt,"bCalcCCrtDate");
	delete (bCalcCCrtDate*)(void*)elt;
}
