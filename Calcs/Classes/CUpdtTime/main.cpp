...
//bTrace trc("lib::init",false);
	(*elt)=new bCalcCUpdtTime(NULL,gapp,bndl);
//trc.msg("parent instance (%x) of %s created",(*elt),"bCalcCUpdtTime");
bGenericXMLBaseElement*	chld;
	
	chld=new bfcalcUpdtTimeElement(*elt,gapp,bndl);
...
//trc.msg("parent instance (%x) of %s deleted",elt,"bCalcCUpdtTime");
	delete (bCalcCUpdtTime*)(void*)elt;
}
