...
//bTrace trc("lib::init",false);
	(*elt)=new bCalcCLastX(NULL,gapp,bndl);
//trc.msg("parent instance (%x) of %s created",(*elt),"bCalcCLastX");
bGenericXMLBaseElement*	chld;
	
	chld=new bfcalcLastXElement(*elt,gapp,bndl);
...
//trc.msg("parent instance (%x) of %s deleted",elt,"bCalcCLastX");
	delete (bCalcCLastX*)(void*)elt;
}
