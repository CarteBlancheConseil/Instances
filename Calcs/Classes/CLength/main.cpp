...
//bTrace trc("lib::init",false);
	(*elt)=new bCalcCLength(NULL,gapp,bndl);
//trc.msg("parent instance (%x) of %s created",(*elt),"bCalcCLength");
bGenericXMLBaseElement*	chld;
	
	chld=new bfcalcLengthElement(*elt,gapp,bndl);
...
//trc.msg("parent instance (%x) of %s deleted",elt,"bCalcCLength");
	delete (bCalcCLength*)(void*)elt;
}
