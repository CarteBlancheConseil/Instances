...
//bTrace trc("lib::init",false);
	(*elt)=new bCalcCCoordY(NULL,gapp,bndl);
//trc.msg("parent instance (%x) of %s created",(*elt),"bCalcCCoordY");
bGenericXMLBaseElement*	chld;
	
	chld=new bfcalcCoordYElement(*elt,gapp,bndl);
...
//trc.msg("parent instance (%x) of %s deleted",elt,"bCalcCCoordY");
	delete (bCalcCCoordY*)(void*)elt;
}
