...
//bTrace trc("lib::init",false);
	(*elt)=new bCalcCNbVertices(NULL,gapp,bndl);
//trc.msg("parent instance (%x) of %s created",(*elt),"bCalcCNbVertices");
bGenericXMLBaseElement*	chld;
	
	chld=new bfcalcNbVerticesElement(*elt,gapp,bndl);
...
//trc.msg("parent instance (%x) of %s deleted",elt,"bCalcCNbVertices");
	delete (bCalcCNbVertices*)(void*)elt;
}
