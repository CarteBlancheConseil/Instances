...
//bTrace trc("lib::init",false);
	(*elt)=new bCalcCPerimeter(NULL,gapp,bndl);
//trc.msg("parent instance (%x) of %s created",(*elt),"bCalcCPerimeter");
bGenericXMLBaseElement*	chld;
	
	chld=new bfcalcPerimeterElement(*elt,gapp,bndl);
...
//trc.msg("parent instance (%x) of %s deleted",elt,"bCalcCPerimeter");
	delete (bCalcCPerimeter*)(void*)elt;
}
