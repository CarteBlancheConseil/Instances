...
//bTrace trc("lib::init",false);
	(*elt)=new bCalcCPerSect(NULL,gapp,bndl);
//trc.msg("parent instance (%x) of %s created",(*elt),"bCalcCPerSect");

bGenericXMLBaseElement*	chld;
	
	chld=new bfcalcPerSectElement(*elt,gapp,bndl);
...
//trc.msg("parent instance (%x) of %s deleted",elt,"bCalcCPerSect");
	delete (bCalcCPerSect*)(void*)elt;
}
