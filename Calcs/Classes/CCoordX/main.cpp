...
//bTrace trc("lib::init",false);
	(*elt)=new bCalcCCoordX(NULL,gapp,bndl);
//trc.msg("parent instance (%x) of %s created",(*elt),"bCalcCCoordX");
bGenericXMLBaseElement*	chld;
	
	chld=new bfcalcCoordXElement(*elt,gapp,bndl);
...
//trc.msg("parent instance (%x) of %s deleted",elt,"bCalcCCoordX");
	delete (bCalcCCoordX*)(void*)elt;
}
