...
//bTrace trc("lib::init",false);
	(*elt)=new bCalcCDist(NULL,gapp,bndl);
//trc.msg("parent instance (%x) of %s created",(*elt),"bCalcCDist");
bGenericXMLBaseElement*	chld;
	
	chld=new bfcalcDistElement(*elt,gapp,bndl);
...
//trc.msg("parent instance (%x) of %s deleted",elt,"bCalcCDist");
	delete (bCalcCDist*)(void*)elt;
}
