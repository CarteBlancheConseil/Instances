...
//bTrace trc("lib::init",false);
	(*elt)=new bCalcCRotation(NULL,gapp,bndl);
//trc.msg("parent instance (%x) of %s created",(*elt),"bCalcCRotation");
bGenericXMLBaseElement*	chld;
	
	chld=new bfcalcRotationElement(*elt,gapp,bndl);
...
//trc.msg("parent instance (%x) of %s deleted",elt,"bCalcCRotation");
	delete (bCalcCRotation*)(void*)elt;
}
