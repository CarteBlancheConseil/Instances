...
//bTrace trc("lib::init",false);
	(*elt)=new bStdUserMacro(NULL,gapp,bndl);
//trc.msg("parent instance (%x) of %s created",(*elt),"bStdUserMacro");
}
...
//trc.msg("parent instance (%x) of %s deleted",elt,"bStdUserMacro");
	delete (bStdUserMacro*)(void*)elt;
}
