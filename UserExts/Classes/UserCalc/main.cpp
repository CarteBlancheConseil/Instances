...
#include <std_ext/bStdUserCalc.h>
...
//bTrace trc("lib::init",false);
	(*elt)=new bStdUserCalc(NULL,gapp,bndl);
//trc.msg("parent instance (%x) of %s created",(*elt),"bStdUserCalc");
}
...
//trc.msg("parent instance (%x) of %s deleted",elt,"bStdUserCalc");
	delete (bStdUserCalc*)(void*)elt;
}
