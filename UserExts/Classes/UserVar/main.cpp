...
//bTrace trc("lib::init",false);
	(*elt)=new bStdUserVar(NULL,gapp,bndl);
//trc.msg("parent instance (%x) of %s created",(*elt),"bStdUserVar");
}
...
//trc.msg("parent instance (%x) of %s deleted",elt,"bStdUserVar");
	delete (bStdUserVar*)(void*)elt;
}
