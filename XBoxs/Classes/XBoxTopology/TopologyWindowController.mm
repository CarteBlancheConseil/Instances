//----------------------------------------------------------------------------
// File : TopologyWindowController.mm
// Project : MacMap
// Purpose : Objective C++ source file : Topology XMapBox window controller
...
#import "TopologyWindowController.h"
#import "bXBoxTopology.h"
#import "CocoaStuff.h"
...
// 
// ------------
@implementation TopologyWindowController

// ---------------------------------------------------------------------------
// 
// ------------
-(id)init{
_bTrace_("[TopologyWindowController init]",true);
	self=[super init];
	if(self){
        _lc=0;
        _lcs=0;
...
// ------------
-(void)dealloc{
_bTrace_("[TopologyWindowController dealloc]",true);
_tm_((void*)self);
	[super dealloc];
}
...
// ------------
-(void)awakeFromNib{
_bTrace_("[TopologyWindowController awakeFromNib]",true);
...
// ------------
-(void)close{
_bTrace_("[TopologyWindowController close]",true);
_tm_((void*)self);
	[super close];
}
...
void* initializeCocoa(void* gapp, 
					  void* ext) {
TopologyWindowController	*controller;
NSAutoreleasePool	*localPool;
	
    localPool=[[NSAutoreleasePool alloc] init];   
    controller=[[TopologyWindowController alloc] init];
